...
public class DomainNameHandler implements OperationStepHandler {
 
    public static final DomainNameHandler INSTANCE = new DomainNameHandler();
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(ModelDefinition.TRUST_DOMAIN_NAME.getKey()).set(name);
