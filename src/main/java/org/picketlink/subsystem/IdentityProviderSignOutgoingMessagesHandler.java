...
public class IdentityProviderSignOutgoingMessagesHandler implements OperationStepHandler {
 
    public static final IdentityProviderSignOutgoingMessagesHandler INSTANCE = new IdentityProviderSignOutgoingMessagesHandler();
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        final boolean signOutgoingMessages = operation.require("value").asBoolean();
        ...
        context.addStep(new OperationStepHandler() {
            ...
            public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                ...
                service.setSignOutgoingMessages(signOutgoingMessages);
