 ...
 */
public class SecurityDomainHandler implements OperationStepHandler {
 
    public static final SecurityDomainHandler INSTANCE = new SecurityDomainHandler();
 
    private SecurityDomainHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(COMMON_SECURITY_DOMAIN.getName()).set(name);
