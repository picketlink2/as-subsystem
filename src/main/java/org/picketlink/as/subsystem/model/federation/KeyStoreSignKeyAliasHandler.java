 ...
 * 
 */
public class KeyStoreSignKeyAliasHandler implements OperationStepHandler {
 
    public static final KeyStoreSignKeyAliasHandler INSTANCE = new KeyStoreSignKeyAliasHandler();
 
    private KeyStoreSignKeyAliasHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(ModelElement.KEY_STORE_SIGN_KEY_ALIAS.getName()).set(name);
