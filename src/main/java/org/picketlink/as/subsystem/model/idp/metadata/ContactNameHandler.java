 ...
 */
public class ContactNameHandler implements OperationStepHandler {
 
    public static final ContactNameHandler INSTANCE = new ContactNameHandler();
 
    private ContactNameHandler() {
    }
