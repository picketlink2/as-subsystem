 ...
 * 
 */
public class KeyStoreURLHandler implements OperationStepHandler {
 
    public static final KeyStoreURLHandler INSTANCE = new KeyStoreURLHandler();
 
    private KeyStoreURLHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(ModelElement.COMMON_URL.getName()).set(name);
