 ...
 */
public class EndpointHandler implements OperationStepHandler {
 
    public static final EndpointHandler INSTANCE = new EndpointHandler();
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(COMMON_ENDPOINT.getName()).set(name);
