 ...
 * 
 */
public class KeyStoreSignKeyPasswdHandler implements OperationStepHandler {
 
    public static final KeyStoreSignKeyPasswdHandler INSTANCE = new KeyStoreSignKeyPasswdHandler();
 
    private KeyStoreSignKeyPasswdHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(ModelElement.KEY_STORE_SIGN_KEY_PASSWD.getName()).set(name);
