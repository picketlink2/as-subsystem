 ...
 */
public class OrganizationURLHandler implements OperationStepHandler {
 
    public static final OrganizationURLHandler INSTANCE = new OrganizationURLHandler();
 
    private OrganizationURLHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(COMMON_URL.getName()).set(name);
