 ...
 */
public class SignOutgoingMessagesHandler implements OperationStepHandler {
 
    public static final SignOutgoingMessagesHandler INSTANCE = new SignOutgoingMessagesHandler();
