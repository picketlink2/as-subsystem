 ...
 */
public class ServiceProviderSecurityDomainHandler implements OperationStepHandler {
 
    public static final ServiceProviderSecurityDomainHandler INSTANCE = new ServiceProviderSecurityDomainHandler();
 
    private ServiceProviderSecurityDomainHandler() {
    }
