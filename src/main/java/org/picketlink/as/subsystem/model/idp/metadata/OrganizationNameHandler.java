 ...
 */
public class OrganizationNameHandler implements OperationStepHandler {
 
    public static final OrganizationNameHandler INSTANCE = new OrganizationNameHandler();
 
    private OrganizationNameHandler() {
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        node.get(COMMON_NAME.getName()).set(name);
