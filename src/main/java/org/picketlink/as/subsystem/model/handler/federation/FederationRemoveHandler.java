 ...
 * 
 */
public class FederationRemoveHandler extends AbstractRemoveStepHandler implements DescriptionProvider {
    ...
    public ModelNode getModelDescription(Locale locale) {
        ...
        node.get(DESCRIPTION).set("Removes a federation configuration");
