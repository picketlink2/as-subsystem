 ...
 */
public class OrganizationAddHandler extends AbstractResourceAddStepHandler {

    public static final OrganizationAddHandler INSTANCE = new OrganizationAddHandler();

    private OrganizationAddHandler() {
        super(ModelElement.IDENTITY_PROVIDER_SAML_METADATA_ORGANIZATION);
    }
